    ...
    public void execute(GuildMessageReceivedEvent event) {
        ...
        switch(args[1].toLowerCase()) {
            case "map":
                ...
                try {
                    URLConnection url = new URL("https://data.germanycovid.de/images/states.png").openConnection();
            ...
            default:
                try {
                    ...
                    if(!(hideVaccinations || vaccinations == null)) {
                        ...
                        LinkedTreeMap<String, Object> boosterVaccination = (LinkedTreeMap<String, Object>) vaccinations.get("boosterVaccination");
                        ...
                        embed.addField("** **", "**Boosterimpfungen**\n" + decimalFormat.format(Math.round(Double.valueOf(String.valueOf(boosterVaccination.get("vaccinated"))))) + " (+" + decimalFormat.format(Math.round((Double)boosterVaccination.get("delta"))) + ")" + "\n**Impfquote**\n" + new DecimalFormat("0.00").format((((Double) boosterVaccination.get("vaccinated")) / ((Double) state.get("population"))) * 100) + "%", true);
                    } else {
